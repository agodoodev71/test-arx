...
/**
 * GetSharingDefinitionsByDocumentTypeIdAndAooCodeRequestDTO Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetSharingDefinitionsByDocumentTypeIdAndAooCodeRequestDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetSharingDefinitionsByDocumentTypeIdAndAooCodeRequestDTO';
    ...
    {
        $this->container['aoo_code'] = isset($data['aoo_code']) ? $data['aoo_code'] : null;
    ...
    {
        return $this->container['aoo_code'];
    }

    /**
     * Sets aoo_code
     *
     * @param string $aoo_code aoo_code
     *
     * @return $this
     */
    public function setAooCode($aoo_code)
    {
        $this->container['aoo_code'] = $aoo_code;
