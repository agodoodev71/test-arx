...
class UserInfoDTO implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'is_unicode' => 'bool',
        'has_avatar' => 'bool',
        'roles' => '\Swagger\Client\Model\RolesInfoDto[]',
        'user' => 'int',
        'group' => 'int',
        'description' => 'string',
        'email' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_unicode'] = isset($data['is_unicode']) ? $data['is_unicode'] : null;
        $this->container['has_avatar'] = isset($data['has_avatar']) ? $data['has_avatar'] : null;
     ...
     * Sets provider
     *
     * @param string $provider Database Type
     *
     * @return $this
     */
    ...
    {
        return $this->container['is_unicode'];
    }

    /**
     * Sets is_unicode
     *
     * @param bool $is_unicode Unicode
     *
     * @return $this
     */
    public function setIsUnicode($is_unicode)
    {
        $this->container['is_unicode'] = $is_unicode;
     ...
     * Gets roles
     *
     * @return \Swagger\Client\Model\RolesInfoDto[]
     */
     ...
     * Sets roles
     *
     * @param \Swagger\Client\Model\RolesInfoDto[] $roles Roles
     *
     * @return $this
     */
    ...
    public function setMarking($marking)
    {
        ...
        if (!is_null($marking) && (!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $marking))) {
            throw new \InvalidArgumentException("invalid value for $marking when calling UserInfoDTO., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
